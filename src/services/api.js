...
export const api = {
    ...
    async getZones(farmId) {
        ...
        return data.map(zone => ({
            ...
            farmId: zone.farm_id,
            userId: zone.user_id,
            agromonitoringId: zone.agromonitoring_id
        }));
    },
    ...
    async addZone(zone) {
            ...
            .insert([
                {
                    ...
                    agromonitoring_id: zone.agromonitoringId || null
                }
            ])
            .select()
            .single();
        ...
        return {
            ...
            agromonitoringId: data.agromonitoring_id
        };
    },
    ...
    async updateZone(id, updates) {
        ...
        if (updates.agromonitoringId) dbUpdates.agromonitoring_id = updates.agromonitoringId;
